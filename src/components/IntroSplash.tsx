...
const LEGACY_SPLASH_KEYS = [
  'stanzawhere-splash-v2',
  'stanzawhere-splash-seen',
]
...
export function IntroSplash({ onDone }: { onDone: () => void }) {
  ...
  const logoSrc = `${import.meta.env.BASE_URL}stanza-logo.png`
  ...
  return (
    ...
    >
      ...
      <div className="intro-card">
        <img className="intro-logo" src={logoSrc} alt="StanzaWhere" />
